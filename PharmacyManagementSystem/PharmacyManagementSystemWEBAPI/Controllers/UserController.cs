...
namespace PharmacyManagementSystemWEBAPI.Controllers
{
    ...
    public class UserController : ApiController
    {
        ...
        {
            this._dataRepository = new UserRepository(new PharmacyManagementSystemEntities2());
        }
        [HttpGet]
        [Route("")]
        ...
        [Route("{id}")]
        //[Route("")]
        public IHttpActionResult Updatuser(int id, [FromBody] UserRegistration userobj)
        {
            if (!ModelState.IsValid)
            {
